...
begin
  ...
  s:= ' select sls_kode,sls_nama Salesman,cus_kode,cus_nama,esd_targetsales targetsales,esd_estimasisales estimasisales,esd_realisasisales realisasisales,CAST(0 AS DECIMAL) ratiosales ,'
    ...
    + ' inner join tsalesman on sls_kode=esh_sls_kode '
    + ' where '
