...
begin
  ...
  begin
    ...
    zAddField(FCDS, 'Invoice', ftString, False,30);
    zAddField(FCDS, 'Nobukti', ftString, False,30);
...
begin
 ...
 if chkPajak.Checked then
  s := ' select inv_nomor,inv_nobukti Nobukti,inv_tanggal,inv_jthtempo,inv_amount, '
