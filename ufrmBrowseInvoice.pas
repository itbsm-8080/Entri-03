...
uses
  ...
  dxSkinsDefaultPainters, cxTextEdit, cxContainer, cxLabel, MyAccess;
...
begin
  Self.SQLMaster := 'select inv_nomor Nomor,inv_nobukti Nobukti,inv_tanggal Tanggal ,inv_jthtempo Jthtempo,inv_Memo Memo ,sup_nama  Supplier, '
                  ...
                  + ' inv_taxamount Ppn,inv_bayar Bayar,inv_freight Freight,if(inv_isbayar=0,"Belum","Sudah") Status_Bayar,inv_ispajak=1 Pajak'
                  + ' from tinv_hdr'
