...
interface
 uses
  ...
  cxGridExportLink,cxFilter,cxGridTableView,cxGridCustomTableView,cxTreeView,
  cxDBTL, cxTLData,cxTLExportLink, MyAccess;
type
 Tbutton1 = class(Tbutton)
  ...
  public
    ...
    procedure SetMultiPurposeLookup;
     ...
     TcxDBTreeHelper = class(TcxDBTreeList)
  public
...
begin
  ...
  begin
    Try
      ...
      showmessage('Data berhasil diexport ke: ' + sFileName);
    except
      showmessage('Gagal menyimpan data ke excel');
    end;
  end;
end;
...
function TcxDBTreeHelper.GetFooterSummary(sFieldName : String): Variant;
//var
//  i: Integer;
begin

end;
function TcxDBTreeHelper.GetFooterSummary(aColumn: TcxGridDBColumn): Variant;
var
  i: Integer;
begin
  Result := Null;
